...
describe("Lottery Contract", () => {
  ...
  it("allows multiple accounts to enter", async () => {
    await enterPlayerInLottery(lottery, accounts[1], web3, "2");
    await enterPlayerInLottery(lottery, accounts[2], web3, "2");
    await enterPlayerInLottery(lottery, accounts[3], web3, "2");
  ...
  it("requires a minimum amount of ether to enter", async () => {
    try {
      await enterPlayerInLottery(lottery, accounts[4], web3, 2);
      assert(false);
    } catch (error) {
      assert(error);
    }
